...
class OutofstockListviewWidget extends StatefulWidget {
  //const OutofstockListviewWidget({Key key}) : super(key: key);

  @override
  _OutofstockListviewWidgetState createState() => _OutofstockListviewWidgetState();
}

class _OutofstockListviewWidgetState extends State<OutofstockListviewWidget> {
                            ...
                            Row(
                              ...
                              Row(
                               ...
                               Row(
                                 mainAxisSize: MainAxisSize.min,
                          children: [
                            const Text('Out of Stock', style: TextStyle(fontSize: 12, color: Colorss.greyText),),
                            Switch(
                              value: isSwitched,
                              onChanged: (value) {
                                setState(() {

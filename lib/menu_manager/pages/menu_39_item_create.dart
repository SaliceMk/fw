      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            ...
            title: Row(
              ...
              children: const [
                Text('Create Item',style: TextStyle(color: Colorss.textIconColor, fontSize: 22),),
              ],
            ),
        //actions: [],
        centerTitle: true,
      ...
      body: SafeArea(
        child: Padding(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: const [
                      Text('Suggested Items', style: TextStyle(color: Colorss.textIconColor, ),),
                      Icon(Icons.arrow_forward_ios, size: 16,color: Colorss.textIconColor,),
                    ],
                  ),
                          style: ElevatedButton.styleFrom(fixedSize:  Size(MediaQuery.of(context).size.width/1, 60),
                ...
                const Text(
                  ...
                  const ListViewPanelWidget(tile1Title: 'Half', tile2Title: 'Full', tile1Subtitle: 'Rs.250', tile2Subtitle: 'Rs.250'),
          ...
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Menu35(appBarTitle: 'Add Variant',textField1: 'Variant Name', textField2: 'Cost Price',buttonLabel: 'ADD',),
            ),
          );
        }, 
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        Icon(Icons.add, size: 16,color: Colorss.textIconColor,),
                        Padding(
                          padding: EdgeInsets.fromLTRB(12, 0, 0, 0),
                          child: Text('Add Item Variants', style: TextStyle(color: Colorss.textIconColor, ),),
                        ),
                      ],
                    ),
                  ),
          ...
          await Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => Menu35(appBarTitle: 'Add Add-Ons',textField1: 'Add-On Name', textField2: 'Cost Price',buttonLabel: 'ADD',),
            ),
          );
        }, 
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(12, 0, 0, 0),
                          child: Text('Add Item Add-On', style: TextStyle(color: Colorss.textIconColor, ),),
                        ),
                      ],
                    ),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(12, 0, 0, 0),
                          child: Text('Select Item Thumbnail', style: TextStyle(color: Colorss.textIconColor, ),),
                        ),
                      ],
                    ),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: const [
                        ...
                        Padding(
                          padding: EdgeInsets.fromLTRB(12, 0, 0, 0),
                          child: Text('Select Slider upto 4 Images', style: TextStyle(color: Colorss.textIconColor, ),),
                        ),
                      ],
                    ),
                  ),
                ...
                Padding(
                  ...
                  child:  ElevatedButton(onPressed: (){}, child: const Text('CREATE',style: TextStyle(color: Colorss.bgColor),),
